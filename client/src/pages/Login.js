  ...
  return (
    ...
    <div className="flex justify-center ">
      ...
      <div className="container bg-slate-100 h-auto w-96 p-4 rounded-lg shadow-lg bg-opacity-5 backdrop-blur-lg text-white mt-20 border-2 mb-12">
        ...
        <Link to={BACKEND_URL+'auth/google'}><div><button className="block w-full p-3 mt-4 rounded-lg text-white bg-red-500 hover:bg-red-600">Sign in with Google</button></div></Link>
